...
int main() {
    ...
    int addr2 = allocate_memory(250);
    display_free_list();

    int addr3 = allocate_memory(600);
    display_free_list();

    free_memory(addr1, 200);
    display_free_list();

    free_memory(addr3, 600); // This should coalesce with the previously freed block if adjacent
    display_free_list();

    int addr4 = allocate_memory (800);
    display_free_list();
